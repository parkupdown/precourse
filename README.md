...
프리코스를 수강하기 전에 클래스, MVC 패턴, TDD, Git, Readme파일 등 
혼자 공부했을 때는 알지 못했던 기술적인 지식 뿐 아니라 , 파일을 꼼꼼히 읽는 것, 인내심, 하면된다는 마인드, 끈질기게 버티는 마음가짐 등 개발자로서 필요한 역량까지
우테코의 프리코스에서 다방면으로 많은 도움을 받았습니다. 단기간에 많은 성장을 느끼게 해주었습니다. 이 프로그램을 소개해준 친구와 미션을 내주시고 피드백 주시고 이끌어주신 코치 , 함께 으쌰으쌰 응원해주시는 참가자 여러분에게 감사를 전해 드립니다!! 정말 감사드립니다! 
너무 많은 것을 배워 이 곳에 다 나열할 수 없을 거 같습니다.. 

 정신차려보니 11월 20일이 넘어있네요. 열심히 했던 만큼 후회는 없지만 좀 더 배울 점이 있진 않았을까 계속해서 의심을 하게 됩니다..그럼에도 잘해왔다고 믿고 스스로를 칭찬해주고 싶습니다! 그래도 잘 버텼다고 고생했다고! 자소서를 쓸 때만해도 제가 이렇게 단기간에 성장 할 수 있을지 몰랐습니다. 지금 프리코스가 끝난다면 이전에 했던 코드들을 다시 리팩토링 하고싶습니다.. 리팩토링이라는 말도 점점 자연스러워지고 1주차만 해도 리팩토링이 무엇인지 구글에 검색을 해봤던 기억이 납니다. 메서드, 프로퍼티, 리팩토링, 깃, 등 구글링을 해도 잘 이해가 안됐던 단어들이 지금은 녹아들어 블로그 글에도 자연스럽게 이러한 용어를 쓰는 저를 발견해 신기합니다!
 특히 블로그 후기글만 보아도 1주차에 비해 4주차에 작성 내용과 질이 더 좋다는 게 보입니다..(😬)
 우테코 정규 코스에 참가해 더 성장하고 잘하고싶지만 이번 프리코스를 모두에게 개방해주신 우테코 관계자분들에게 정말 감사의 말씀 드리고 싶습니다!!
너무너무 감사드립니다. 어떤 강의, 어떤 교육자료보다 도움이 많이 됐습니다. 
코드에 대한 자신감 뿐아니라 하면된다는 마인드를 가장 많이 심어주신거 같습니다.
이전 누군가 미션을 주지않았을때는 그냥 내가 아는부분에서 효율적이지 않더라도 그렇게 부딪히지 않고 피해 프로그래밍을 했던 거 같습니다. 그러니 어제의 코드나 내일의 코드가 큰 차이가 없었던 거 같습니다.. 이게 될까싶은 문제들을 마주했을 때 계속 끈질기게 물고 늘어지니 문제는 곧 쓰러지고 나아가는 제 모습만 남아있었습니다. 뭘해도 할수있겠다라는 조금 오바스럽지만 정말 그런 생각이 들었습니다. 독학한지 8~9개월이 됐습니다. 그 중 가장 단기간에 많은 성장을 이룬 1달이었습니다. 간절한 마음으로 시작해서 포기하지 않고 여기까지 달려올 수 있었던 거 같습니다. 많은 코치 여러분들 그리고 참가자 여러분들에게 진심을 감사의 마음을 전달해드리고 싶습니다!! 감사합니다

누군가 단기간에 성장을 느끼고 싶다면 저는 이 우테코를 추천해 드릴 거 같습니다!! 🔥
